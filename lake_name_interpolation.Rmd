---
title: "Lake Name Spatial Interpolation"
author: Nicole Smith
date: 2020-02-07
output: github_document
---
# Introduction
Map figures are re-used by the author from:
Soranno, P.A., Webster, K.E., Smith, N.J., Díaz Vázquez, J. and Cheruvelil, K.S. (2020), What Is in a “Lake” Name? That Which We Call a Lake by Any Other Name. Limnology and Oceanography Bulletin. [doi:10.1002/lob.10355](https://doi.org/10.1002/lob.10355).
...
Create a prediction grid for k-nearest neighbors. This is a point object that we will visualize with ggplot::geom_raster() later. The k-value will determine how local vs. glocal the predicted patterns appear, but the cell size will also determine how that translates to the visual effect of the map. I used artistic license in the selection of both--I want a map in which the color blending would be interpretable, that blurs over some of the very local quirks in naming, and that doesn't look chunky or pixelated.
```{r}
